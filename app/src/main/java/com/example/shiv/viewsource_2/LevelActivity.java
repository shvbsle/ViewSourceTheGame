...
public class LevelActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        menu = new Intent(LevelActivity.this, WelcomeTerminal.class);
        startActivity(menu);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        in = new Intent(LevelActivity.this, SourceActivity.class);
        menu = new Intent(LevelActivity.this, WelcomeTerminal.class);
        ...
        final GridAdapter adapter = new GridAdapter(LevelActivity.this, sprite, char_pos);
        ...
        img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(LevelActivity.this, "Illegal Move", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        for(int i = 0; i <15; i ++){
            for(int j = 0; j< 10; j++){
                ...
                if (world_array[i][j].equals("%")){
                    ...
                    sprite[counter] = R.drawable.vir3;
                    Variables.cx = i;
                    Variables.cy = j;
                }
...
//            }
            ...
            GridAdapter ad2 = new GridAdapter(LevelActivity.this, sprite, char_pos);
            ...
            if(Variables.cx == Variables.gx && Variables.cy == Variables.gy){
                Toast.makeText(LevelActivity.this, "Level Won!", Toast.LENGTH_SHORT).show();
                Variables.log_book+="[D-352|T-04:79]\n" +
                        "Dear Dairy,\n" +
                        "\tHoly Shit! Holy Shit! Holy Shit! I touched that flag Object and I was suddenly in a different place! " +
                        "\n\tI knew for a fact that I cannot move but I moved... I am supposed to be a meaningless bunch of pixels. uugh I'm " +
                        "confused!! What is this!?\n\n";

                Toast.makeText(LevelActivity.this, "Journal Updated!", Toast.LENGTH_SHORT).show();
                Variables.enter_level = true;
                startActivity(menu);
...
//            }
            ...
            Toast.makeText(LevelActivity.this, "Instruction Queue Empty!", Toast.LENGTH_SHORT).show();
        }
